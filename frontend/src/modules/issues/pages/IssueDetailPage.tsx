        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-slate-900/90 backdrop-blur-md p-6 rounded-2xl border border-slate-800 space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-base font-bold text-white font-outfit">AI Agent Execution Logs Audit Trail</h3>
            </div>
            ...
            <div className="space-y-3 pt-2">
              {agentLogs.length === 0 ? (
                [
                  ...
                  { id: 'log_2', stepNumber: 2, agentName: 'Vision Analysis Agent', confidence: 0.94, executionTime: 130, status: 'success', reasoning: 'Computer vision hazard confirmed.', input: { mediaCount: complaint.mediaFiles?.length || 0 }, output: { detectedIssue: complaint.title, severity: complaint.severity || complaint.priorityLevel, tokenUsage: { promptTokens: 140, completionTokens: 55, totalTokens: 195 } } },
                  ...
                  return (
                    <div key={log.id} className="rounded-xl bg-slate-950 border border-slate-800 overflow-hidden text-xs">
                      <div
                ...
                agentLogs.map((log) => {
                  ...
                  return (
                    <div key={logId} className="rounded-xl bg-slate-950 border border-slate-800 overflow-hidden text-xs">
                      <div
