                    ...
                    return (
                        <React.Fragment key={agent.id}>
                            <motion.div
                                ...
                                className={`glass-panel p-5 rounded-2xl border transition-all ${isExecuted
                            ...
                            >
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                    ...
                                    <div className="flex items-start space-x-4">
                                        <div
                                            className={`w-11 h-11 rounded-xl flex items-center justify-center font-bold transition-all flex-shrink-0 ${isExecuted
                            ...
                            {index < AGENT_METADATA.length - 1 && (
                                <div className="flex justify-center py-1">
                                    <div className={`w-8 h-8 rounded-full flex items-center justify-center border transition-all ${isExecuted ? 'bg-cyan-500/10 border-cyan-500/30 text-cyan-400' : 'bg-slate-950 border-slate-800 text-slate-700'
                                        }`}>
